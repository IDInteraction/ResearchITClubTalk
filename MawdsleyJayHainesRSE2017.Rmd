...
Include diagram slides from Dockerworkshop of pipeline

## Challenges

Additional complexity
Building the paper can be a challenge even with Docker
...
[](Good figures:  Heath Robinson or Wallis and Gromit contraption?)
